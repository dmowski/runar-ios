...
class EightRuneView: UIView {
    ...
    func setUpContent() {
        ...
        aligmentThreeButton.layer.borderColor = Assets.Colors.Touch.layerBorder.color.cgColor
        ...
        aligmentFourButton.layer.borderColor = Assets.Colors.Touch.layerBorder.color.cgColor
        ...
        aligmentFiveButton.layer.borderColor = Assets.Colors.Touch.layerBorder.color.cgColor
        ...
        aligmentSixButton.layer.borderColor = Assets.Colors.Touch.layerBorder.color.cgColor
        aligmentSixButton.layer.cornerRadius = 25
        aligmentSixButton.layer.borderWidth = 1
        aligmentSixButton.setTitle("6", for: .normal)
        
        aligmentSevenButton.backgroundColor = Assets.Colors.UnTouch.layerBackground.color
        aligmentSevenButton.layer.borderColor = Assets.Colors.Touch.layerBorder.color.cgColor
        ...
        aligmentSevenButton.setTitleColor(Assets.Colors.UnTouch.text.color, for: .normal)
        
        addSubview(aligmentSevenButton)
