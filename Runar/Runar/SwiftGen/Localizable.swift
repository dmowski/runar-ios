...
internal enum L10n {
  ...
  internal enum Description {
    ...
    internal enum Total {
      ...
      internal static let þurisaz = L10n.tr("Localizable", "description.total.Þurisaz")
      internal enum Reverse {
        ...
        internal static let þurisaz = L10n.tr("Localizable", "description.total.Reverse.Þurisaz")
      }
    }
    internal enum Value {
      /// Новая перспектива
