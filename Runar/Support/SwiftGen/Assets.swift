...
internal enum Assets {
  ...
  internal static let кельтскийКрест = ImageAsset(name: "Кельтский крест")
  internal static let краткийПрогноз = ImageAsset(name: "Краткий прогноз")
  internal static let крестСтихий = ImageAsset(name: "Крест стихий")
  internal static let крест = ImageAsset(name: "Крест")
  internal static let молотТора = ImageAsset(name: "Молот Тора")
  internal static let норны = ImageAsset(name: "Норны")
  internal static let раскладИз2Рун = ImageAsset(name: "Расклад из 2 рун")
  internal static let рунаДня = ImageAsset(name: "Руна дня")
