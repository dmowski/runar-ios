...
internal enum L10n {
  ...
  internal enum FirstScreen {
    internal enum ButtomLabel {
      ...
      internal static let title = L10n.tr("Localizable", "firstScreen.buttomLabel.title")
    }
    internal enum CheckBoxLabel {
      /// Do not show again
      internal static let title = L10n.tr("Localizable", "firstScreen.checkBoxLabel.title")
    }
    internal enum MediumLabel {
      /// Today the Gods favor you!
      internal static let title = L10n.tr("Localizable", "firstScreen.mediumLabel.title")
    }
    internal enum NextButton {
      /// Go ahead
      internal static let title = L10n.tr("Localizable", "firstScreen.nextButton.title")
    }
    internal enum TopLabel {
      /// Greetings, young Nordling!
      internal static let title = L10n.tr("Localizable", "firstScreen.topLabel.title")
    }
  }
